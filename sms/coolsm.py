...
if __name__ == "__main__":
    ...
    api_key = "NCSCIIDVAVP5LZDM" 
    api_secret = "UK9AJBYTR5ACUEM5XR7P7QLZGET3RITZ"
    ...
    params['to'] = '01041284187, 01097804624'  # 수신자 번호 입력, 다중으로 보내려면 '01012341234, 01043214321' 으로 입력
    params['from'] = '01097804624'  # 발신자 번호 입력, api_key에 할당된 소유자의 번호로 입력해야 성공적으로 진행됨
    params['text'] = '메시지 전송 테스트'  # 보낼 텍스트
